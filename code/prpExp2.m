...
for k=2:5
    ...
    [Xi, yi] = prpGetData(subject);
    X=Xi; y=yi;
    subject=['S0' num2str(sOrder(2))];
    [Xi, yi] = prpGetData(subject);
    X=cat(2,X,Xi); y=cat(2,y,yi);
    ...
    for i=1:length(X)
        if any(y(1:5,i))
            if exist('tTrain', 'var')
                xTrainImages=cat(2,xTrainImages,X(i));
                tTrain=cat(2,tTrain,y(1:5,i));
            else
                xTrainImages=X(i);
                tTrain=y(1:5,i);
            end
    ...
    [X, y] = prpGetData(subject);
    
    for i=1:length(X)
        if any(y(1:5,i))
            if exist('tTest', 'var')
                xTestImages=cat(2,xTestImages,X(i));
                tTest=cat(2,tTest,y(1:5,i));
            else
                xTestImages=X(i);
                tTest=y(1:5,i);
            end
    ...
    autoenc1 = trainAutoencoder(xTrainImages,hiddenSize1, ...
        ...
        'ScaleData', false);
    save(['exp2-k-' num2str(k) '-' subject '-autoenc1.mat'], 'autoenc1');
    ...
    autoenc2 = trainAutoencoder(feat1,hiddenSize2, ...
        ...
        'ScaleData', false);
    save(['exp2-k-' num2str(k) '-' subject '-autoenc2.mat'], 'autoenc2');
    ...
    save(['exp2-k-' num2str(k) '-' subject '-softnet.mat'], 'softnet');
    ...
    save(['exp2-k-' num2str(k) '-' subject '-deepnet.mat'], 'deepnet');
    ...
    tesMtr = prpGetMetrics(y, tTest);
    plotconfusion(tTest,y);

    save(['exp2-k-' num2str(k) '-' subject '-Metr.mat'], '*Mtr', 'tTest', 'y');
    
    clear *Mtr x* t* softnet auto* feat*
